...
print(findall(r'he[a-z]?',sentence))#for only one char
print(findall(r'he[a-z]+',sentence))# for one or more char
print(findall(r'\bhe[a-z]*\b',sentence)) #for 0 or more char \b is for word boundary
# -------------------------------------------------------------------------------------------------------
# Groups ( )
# -------------------------------------------------------------------------------------------------------------
